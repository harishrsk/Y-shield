    ...
    <div className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-[10px] md:text-[11px] font-bold text-emerald-500 tracking-[0.3em] uppercase mb-4">Institutional Framework</h2>
          <p className="text-3xl font-light tracking-tight text-white sm:text-5xl mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {Object.values(TIERS).map((tier) => (
            <div key={tier.tier} className="relative p-6 sm:p-10 bg-white/[0.03] border border-white/5 rounded-[2rem] flex flex-col hover:bg-white/[0.05] hover:border-emerald-500/30 transition-all duration-500 group">
